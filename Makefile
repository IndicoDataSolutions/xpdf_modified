...
#	$(INSTALL_PROGRAM) xpdf/xpdf$(EXE) $(DESTDIR)${exec_prefix}/bin/xpdf$(EXE)
	...
	$(INSTALL_PROGRAM) xpdf/pdfdetach$(EXE) $(DESTDIR)${exec_prefix}/bin/pdfdetach$(EXE)
...
#	$(INSTALL_DATA) $(srcdir)/doc/xpdf.1 $(DESTDIR)${prefix}/share/man/man1/xpdf.1
	$(INSTALL_DATA) $(srcdir)/doc/pdftops.1 $(DESTDIR)${prefix}/share/man/man1/pdftops.1
	$(INSTALL_DATA) $(srcdir)/doc/pdftotext.1 $(DESTDIR)${prefix}/share/man/man1/pdftotext.1
	$(INSTALL_DATA) $(srcdir)/doc/pdfinfo.1 $(DESTDIR)${prefix}/share/man/man1/pdfinfo.1
	$(INSTALL_DATA) $(srcdir)/doc/pdffonts.1 $(DESTDIR)${prefix}/share/man/man1/pdffonts.1
	$(INSTALL_DATA) $(srcdir)/doc/pdfdetach.1 $(DESTDIR)${prefix}/share/man/man1/pdfdetach.1
#	$(INSTALL_DATA) $(srcdir)/doc/pdftoppm.1 $(DESTDIR)${prefix}/share/man/man1/pdftoppm.1
	$(INSTALL_DATA) $(srcdir)/doc/pdfimages.1 $(DESTDIR)${prefix}/share/man/man1/pdfimages.1
	-mkdir -p $(DESTDIR)${prefix}/share/man/man5
	$(INSTALL_DATA) $(srcdir)/doc/xpdfrc.5 $(DESTDIR)${prefix}/share/man/man5/xpdfrc.5
